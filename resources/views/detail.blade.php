      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav justify-content-end">
          ...
          <li class="nav-item active">
            ...
            <a class="nav-link" href="{{route('users.index')}}">BERANDA</a>
          </li>
            ...
            <div id="template-row" class="row justify-content-center align-items-center">
                <div id="template-column" class="col-md">
                    <div id="template-box" class="col-md-12 content">
                    	<h4 style="padding: 20px;">Data Tower</h4>
                        <!--membuat table -->
                        <table class="table table-striped">
							...
							<tbody>
								...
								<?php $i=1; ?>
							<!-- perulangan foreach dengan variabel towers sebagai variabel t -->
        							@foreach($towers as $t)
            							<tr>
                                            <!--perulangan dengan penambahan 1-->
            								<td>{{$i++}}</td>
                                            <!--mengambil kolom dari database-->
            								<td>{{$t->nama_tower}}</td>
            								<td>{{$t->koor_lat}}</td>
            								<td>{{$t->koor_leng}}</td>	
