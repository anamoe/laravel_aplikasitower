			...
			<div class="col-lg-6 ">
			    ...
			    @foreach ($towers as $tower)
			        ...
			        <script type="text/javascript">
			            ...
			            array.push(['<?php echo $tower->koor_lat?>','<?php echo $tower->koor_leng?>','<?php echo $tower->nama_tower?>','<?php echo $tower->foto->foto ?? ' '?>','<?php echo $tower->tinggi?>','<?php echo $tower->id?>']);
