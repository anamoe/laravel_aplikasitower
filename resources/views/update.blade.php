                ...
                <div id="login-column" class="col-md">
                    <div id="login-box" class="col-md-12 content">
                        ...
                        <div class="row" style="padding: 20px;">
                            ...
                            <div class="col-md">
                                <form action="{{route('update',$towers->id)}}" method="POST" enctype="multipart/form-data" file="true">
                                    {{ csrf_field() }}
                                    {{ method_field('PUT') }}
                                    ...
                                    <input type="number" step="any" id="leng" name="koor_leng" value="{{$towers->koor_leng}}" class="form-control {{$errors->has('koor_leng') ? 'is-invalid' : '' }}">
                                    ...
                                    <input type="text" name="nama_tower" value="{{$towers->nama_tower}}" placeholder="Nama Perusahaan"class="form-control {{$errors->has('nama_tower') ? 'is-invalid' : '' }}">
                                    ...
                                    <input type="text" name="alamat" value="{{$towers->alamat}}" placeholder="Alamat" class="form-control {{$errors->has('alamat') ? 'is-invalid' : '' }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md">
                                            ...
                                            <label>Rt.</label>
                                            <input type="text" name="rt" id="form-name" value="{{$towers->rt}}" placeholder="Rt." class="form-control {{$errors->has('rt') ? 'is-invalid' : '' }}">
                                             @if($errors->has('rt'))
                                                <div class="invalid-feedback">
                                                  Wajib di Isi!
                                                </div>
                                        ...
                                        <div class="col-md">
                                            ...
                                            <input type="text" name="rw" id="form-name" value="{{$towers->rw}}" placeholder="Rw."class="form-control {{$errors->has('rw') ? 'is-invalid' : '' }}">
                                            @if($errors->has('rw'))
                                                <div class="invalid-feedback">
                                                  Wajib di Isi!
                                                </div>
                                    ...
                                    <input type="text" name="tinggi" value="{{$towers->tinggi}}" placeholder="Ketinggian" class="form-control {{$errors->has('tinggi') ? 'is-invalid' : '' }}">
                                    ...
                                    <input type="text" name="nama_pemilik_tower" value="{{$towers->nama_pemilik_tower}}" placeholder="Pemilik Tower" class="form-control {{$errors->has('nama_pemilik_tower') ? 'is-invalid' : '' }}">
                                    ...
                                    <input type="date" name="tanggal_imb" value="{{$towers->tanggal_imb}}" class="form-control {{$errors->has('tanggal_imb') ? 'is-invalid' : '' }}">
                                    ...
                                    <input type="text" name="ket_pemilik" value="{{$towers->ket_pemilik}}" placeholder="Sewa atau Milik Perusahaan" class="form-control {{$errors->has('ket_pemilik') ? 'is-invalid' : '' }}">
                                    ...
                                    <input type="date" name="akhir_sewa" value="{{$towers->akhir_sewa}}" class="form-control {{$errors->has('akhir_sewa') ? 'is-invalid' : '' }}">
                                    @if($errors->has('akhirs_sewa'))
                                        <div class="invalid-feedback">
                                          Wajib di Isi!
                                        </div>
                                    ...
                                    <input type="text" name="nama_pemilik_lahan" value="{{$towers->nama_pemilik_lahan}}" placeholder="Pemilik Lahan" class="form-control {{$errors->has('nama_pemilik_lahan') ? 'is-invalid' : '' }}">
